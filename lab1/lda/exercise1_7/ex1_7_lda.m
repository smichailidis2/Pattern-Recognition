...
NewDim = [1,2]; %The new feature dimension after applying LDA

for i = NewDim
    v = myLDA(meas_norm, iris_labels, i);
    ...
    iris_reduced1 = meas_reduced(iris_labels == 0,:);
    iris_reduced2 = meas_reduced(iris_labels == 1,:);
    iris_reduced3 = meas_reduced(iris_labels == 2,:);
    
    %  Use different color/symbol for each class
    figure
    hold on
    plot(iris_reduced1(:,1),iris_reduced1(:,i),'bo')
    plot(iris_reduced2(:,1),iris_reduced2(:,i),'rs')
    plot(iris_reduced3(:,1),iris_reduced3(:,i),'g+')
    hold off
end
...
figure
hold on
plot3(iris_reduced1(:,1),iris_reduced1(:,2),iris_reduced1(:,3),'bo')
plot3(iris_reduced2(:,1),iris_reduced2(:,2),iris_reduced2(:,3),'rs')
plot3(iris_reduced3(:,1),iris_reduced3(:,2),iris_reduced3(:,3),'g+')
hold off
